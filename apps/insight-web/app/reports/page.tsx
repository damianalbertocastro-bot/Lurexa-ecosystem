...
import { InstitutionalAnalyticsService } from "@lurexa/backend";
...
export default function ReportsPage() {
  ...
  const handleDownload = (title: string) => {
    ...
    try {
      const analytics = InstitutionalAnalyticsService.getCohortAnalytics("uasd-santo-domingo");
      const csvContent = InstitutionalAnalyticsService.exportCohortComplianceCsv(analytics);
