// Lurexa Learn Service Worker - Field Pilot Offline Resiliency
const CACHE_NAME = "lurexa-learn-v1";
const AUDIO_CACHE = "lurexa-audio-cache-v1";
...
self.addEventListener("fetch", (event) => {
  ...
  // 1. Audio assets & Phonetic audio files -> Cache-First Strategy
  if (
    ...
    event.respondWith(
      caches.open(AUDIO_CACHE).then(async (cache) => {
        ...
        try {
          ...
          // If offline and not in cache, return fallback 404
  ...
  // 2. Next.js Static Chunks & Assets -> Stale-While-Revalidate
