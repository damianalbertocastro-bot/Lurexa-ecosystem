...
export const CoachPracticeCard: React.FC = () => {
  ...
  return (
    <article className="relative overflow-hidden rounded-3xl border border-indigo-500/30 bg-gradient-to-br from-[#0a1931] via-[#12234c] to-[#1c3570] p-6 text-white shadow-xl shadow-indigo-950/20 sm:p-8">
