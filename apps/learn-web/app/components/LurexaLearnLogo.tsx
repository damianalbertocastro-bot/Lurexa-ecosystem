...
export function LurexaLearnLogo({ inverse = false, href = "/" }: { inverse?: boolean; href?: string }) {
  ...
  return (
    <Link href={href} className="inline-flex items-center gap-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2" aria-label="Lurexa Learn home">
