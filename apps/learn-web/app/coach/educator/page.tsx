...
export default function EducatorCoachEntryPage() {
  ...
  return <main className="min-h-screen bg-gradient-to-b from-[#f7f2ff] to-[#eef3ff] px-5 py-10 text-[#10245f]"><div className="mx-auto max-w-3xl">
    ...
    <section className="mt-8 rounded-[34px] border border-violet-100 bg-white p-7 shadow-xl sm:p-10">
      ...
      <p className="mt-5 text-sm leading-7 text-[#4d5e8c]">This mode is available through your educator benefit. It focuses on your pronunciation, fluency, and professional language development. It does not expose student records, and Coach cannot grant or change your professional qualification.</p>
