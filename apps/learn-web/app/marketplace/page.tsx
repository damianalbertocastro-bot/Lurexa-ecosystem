    ...
    <main className="min-h-screen bg-[var(--learn-canvas)] px-4 py-10 sm:px-8">
      <section className="mx-auto max-w-4xl rounded-[32px] border border-[var(--lx-border)] bg-white p-8 shadow-[0_18px_50px_rgba(32,52,128,.08)] sm:p-12">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          <article className="rounded-2xl border border-[var(--lx-border)] bg-[var(--lx-canvas)] p-5">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <Link href="/teacher/dashboard" className="rounded-xl border border-[var(--lx-border)] px-5 py-3 text-sm font-black text-[var(--color-brand-navy)]">
            Teacher Workspace
          </Link>
        </div>
      </section>
