      ...
      >
        <form onSubmit={handleSaveLesson} className="space-y-4">
          ...
          <label className="block text-sm font-medium text-[#314b88]">
            Lesson content
            <textarea className="mt-1 w-full rounded-xl border border-[#d7e0f6] p-3 text-[var(--color-brand-navy)]" value={lessonContent} onChange={(event) => setLessonContent(event.target.value)} rows={8} required />
          </label>
