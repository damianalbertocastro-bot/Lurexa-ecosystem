...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-[var(--lx-canvas)] text-slate-950">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        {/* Global Navigation */}
        <nav className="relative z-10 mx-auto flex max-w-7xl items-center justify-between gap-3 px-5 py-5 sm:px-8">
      ...
      <footer className="border-t border-[var(--lx-border)] bg-white py-12 text-slate-600">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-5 sm:flex-row sm:px-8">
          ...
          <div className="flex flex-wrap items-center gap-5 text-xs font-bold text-[var(--lx-muted)]">
