...
{error&&<p role="alert" className="mt-5 rounded-2xl border border-rose-300 bg-rose-50 p-4 text-sm font-extrabold text-slate-950 dark:border-rose-800 dark:bg-rose-950/40 dark:text-white shadow-xs">{error}</p>}
