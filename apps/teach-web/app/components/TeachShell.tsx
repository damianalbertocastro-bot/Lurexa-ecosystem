  ...
  return <div className="min-h-screen bg-[#f5f7ff] text-[#0b1f5f]">
    <header className="sticky top-0 z-40 border-b border-[#dfe6f8]/90 bg-white/90 backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1440px] items-center gap-5 px-5 py-3 sm:px-8">
        <a href="/" aria-label="Lurexa Teach home" className="shrink-0 rounded-xl"><ProductMark product="teach" /></a>
        ...
        <div className="ml-auto flex items-center gap-2"><a href={ecosystemUrl} aria-label="Lurexa ecosystem" className="grid h-11 w-11 place-items-center rounded-xl border border-[#dfe6f8] bg-white text-[#592bd6] shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"><MasterMark compact /></a><a href="/dashboard" className="hidden min-h-11 items-center rounded-xl bg-gradient-to-br from-[#6b2bd9] to-[#315fd7] px-4 text-sm font-extrabold text-white shadow-[0_12px_24px_rgba(71,65,190,.22)] sm:inline-flex">My Teach</a></div>
      </div>
