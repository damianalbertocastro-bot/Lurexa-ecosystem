  ...
  return <div className="min-h-screen bg-[#f5f7ff] text-[#071d67]">
    <header className="sticky top-0 z-50 border-b border-[#dfe6f8]/90 bg-white/90 backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1480px] items-center gap-4 px-5 py-3 sm:px-8">
        ...
        <div className="ml-auto flex items-center gap-2"><Link href="/search" aria-label="Search Lurexa Docs" className="inline-flex min-h-11 items-center rounded-xl border border-[#d7e0f6] bg-[#f8faff] px-3.5 text-sm font-extrabold text-[#315fd7] transition hover:border-[#b8c7f1] hover:bg-white"><span aria-hidden="true">⌕</span><span className="ml-2 hidden sm:inline">Search</span></Link><a href={ecosystemUrl} className="inline-flex min-h-11 items-center rounded-xl border border-[#d7e0f6] bg-white px-3.5 text-sm font-extrabold text-[#3450a8] shadow-sm transition hover:-translate-y-0.5 hover:border-[#b8c7f1] hover:shadow-md">Ecosystem ↗</a></div>
      </div>
