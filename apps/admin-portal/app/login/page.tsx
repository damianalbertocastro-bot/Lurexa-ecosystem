...
export default function AdminLoginPage() {
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-gradient-to-br from-[#eef2ff] via-white to-[#e9fbff] px-5 py-10 text-[#071d67]">
          ...
          <form className="space-y-4 pt-2" onSubmit={(event) => void submit(event)}>
            <div>
              ...
              <input
                ...
                className="min-h-12 w-full rounded-xl border border-[#d8e0f6] bg-white px-3.5 text-sm text-[#071d67] outline-none transition focus:border-[#6a5af9] focus:ring-4 focus:ring-[#6a5af9]/10"
              />
            </div>
            <div>
