...
export function AdminRelatedExperiences() {
  ...
  return <div className="bg-[var(--lx-surface)] px-5 pb-14 sm:px-8"><div className="mx-auto max-w-7xl">
    <section className="mb-8 grid gap-4 sm:grid-cols-2" aria-label="Admin governance tools">
      <Link href="/educators" className="rounded-3xl border border-[var(--lx-border)] bg-white p-6 text-[var(--color-brand-navy)] shadow-[0_12px_30px_rgba(32,52,128,.06)] transition hover:-translate-y-0.5 hover:border-[var(--lx-secondary)] motion-reduce:transform-none motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--lx-secondary)]"><p className="text-[10px] font-extrabold uppercase tracking-[.16em] text-[var(--lx-secondary)]">EDUCATOR GOVERNANCE</p><h2 className="mt-2 text-xl font-black">Qualifications and teaching authorization</h2><p className="mt-2 text-sm leading-6 text-[var(--lx-muted)]">Inspect trusted educator scope and assign institution courses without treating membership roles as teaching qualification.</p><span className="mt-4 inline-flex text-sm font-extrabold text-[var(--lx-secondary)]">Manage educators →</span></Link>
      <Link href="/signature-operations" className="rounded-3xl border border-[var(--lx-border)] bg-white p-6 text-[var(--color-brand-navy)] shadow-[0_12px_30px_rgba(32,52,128,.06)] transition hover:-translate-y-0.5 hover:border-[var(--lx-secondary)] motion-reduce:transform-none motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--lx-secondary)]"><p className="text-[10px] font-extrabold uppercase tracking-[.16em] text-[var(--lx-secondary)]">SIGNATURE OPERATIONS</p><h2 className="mt-2 text-xl font-black">Experience health and continuity</h2><p className="mt-2 text-sm leading-6 text-[var(--lx-muted)]">Review identity-free Signature projection health, Product Bridge continuity, and latency budgets.</p><span className="mt-4 inline-flex text-sm font-extrabold text-[var(--lx-secondary)]">Open operations →</span></Link>
    </section>
