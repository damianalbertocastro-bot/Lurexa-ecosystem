...
const communityUrl = `${teachUrl.replace(/\/$/, "")}/community`;
...
export function TeacherRelatedExperiences() {
  ...
  const items: RelatedExperience[] = [
    ...
    { kind: "teach-community", title: "Teach Community", description: "Exchange classroom ideas, evidence, feedback, and resources with other educators in professional circles.", href: communityUrl, cta: "Open community" },
