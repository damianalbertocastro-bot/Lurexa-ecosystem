...
export function buildB1ProductionCurriculum(now: string = new Date().toISOString()): B1ProductionCurriculumBundle {
  ...
  const course: Course = {
    ...
    description: "Comprehensive 8-module intermediate course for expressing opinions, professional discourse, media evaluation, and independent communicative autonomy.",
    subject: "english",
    status: "published",
    isTemplate: false,
