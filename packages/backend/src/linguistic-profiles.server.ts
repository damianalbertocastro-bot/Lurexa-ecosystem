...
export const REGIONAL_LINGUISTIC_PROFILES: Record<string, LinguisticTransferProfile> = {
  "es-DO": {
    ...
    interferenceRules: [
      ...
      {
        ruleId: "DO-ENG-PRO-004",
        sourceL1Feature: "Initial voiceless stop lack of aspiration (/p/, /t/, /k/)",
        targetEnglishInterference: "Unaspirated English /p, t, k/ in stressed syllable onsets perceived by native listeners as /b, d, g/ (e.g. 'pin' sounding like 'bin', 'time' sounding like 'dime').",
        phonemeOrStructureTarget: "Voiceless aspirated stops [pʰ, tʰ, kʰ] in stressed syllable onset",
        pedagogicalStrategy: "Paper flutter breath burst drill verifying strong air expulsion on initial voiceless plosives.",
        exampleInterference: "The [p=]en is on the [t=]able.",
        targetCorrection: "The [pʰ]en is on the [tʰ]able.",
      },
      {
        ruleId: "DO-ENG-PRO-005",
        sourceL1Feature: "Word-final nasal velarization (/-n/ -> [ŋ])",
        targetEnglishInterference: "Velarizing word-final alveolar /n/ to [ŋ], blurring minimal pairs like 'sun' vs 'sung', 'thin' vs 'thing', 'run' vs 'rung'.",
        phonemeOrStructureTarget: "Word-final alveolar nasal /n/ vs velar nasal /ŋ/",
        pedagogicalStrategy: "Alveolar ridge tactile hold drill anchoring tongue-tip to roof of mouth at the end of words.",
        exampleInterference: "The su[ŋ] is warm.",
        targetCorrection: "The su[n] is warm.",
      },
      {
        ruleId: "DO-ENG-PRO-006",
        sourceL1Feature: "Liquid consonant neutralization (vocalic glide [i̯] or lambdacism /r/ -> /l/)",
        targetEnglishInterference: "Weakening or gliding coda liquids in rapid speech, producing vocalic glides instead of firm rhotic /ɹ/ or lateral /l/ (e.g. 'cai' for 'car').",
        phonemeOrStructureTarget: "Syllable-coda liquid contrast /ɹ/ vs /l/",
        pedagogicalStrategy: "Firm alveolar anchor for /l/ and retroflex tongue pull for /ɹ/ before terminal silence.",
        exampleInterference: "We park the cai outside.",
        targetCorrection: "We park the car outside.",
      },
    ],
  },
  "es-PR": {
