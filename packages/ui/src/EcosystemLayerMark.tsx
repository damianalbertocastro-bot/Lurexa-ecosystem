...
function LayerGlyph({ layer }: { layer: LurexaEcosystemLayer }) {
  if (layer === "core") {
    return (
      <svg viewBox="0 0 80 80" className="h-full w-full" aria-hidden="true">
        <path d="M40 7 66 22v36L40 73 14 58V22L40 7Z" fill="var(--color-brand-navy)" />
        <path d="M40 19 55 28v24L40 61 25 52V28L40 19Z" fill="#2160df" />
        <circle cx="40" cy="40" r="9" fill="var(--lx-accent)" />
  ...
  return (
    <svg viewBox="0 0 80 80" className="h-full w-full" aria-hidden="true">
      ...
      <path d="M40 20v40M24 31c8 0 10 6 10 10M56 31c-8 0-10 6-10 10M24 54c7 0 10-4 10-8M56 54c-7 0-10-4-10-8" fill="none" stroke="var(--lx-accent)" strokeWidth="4" strokeLinecap="round" />
