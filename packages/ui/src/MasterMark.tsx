    ...
    <span className={`inline-flex items-center ${classes.rootGap} ${className}`} {...props}>
      ...
      >
        <svg viewBox="0 0 80 80" className="h-full w-full" style={{ display: "block", width: "100%", height: "100%" }} aria-hidden="true">
          ...
          <path d="M39 42c-15 0-27 8-30 23-1 5 4 9 9 7 14-4 22-15 22-30Z" fill="var(--color-brand-navy)" opacity=".94" />
          <path d="M41 42c0 15 8 26 22 30 5 2 10-2 9-7-3-15-15-23-30-23Z" fill="var(--lx-accent)" />
