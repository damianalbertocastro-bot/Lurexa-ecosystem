...
export const productPersonalities: Record<LurexaExperienceId, ProductPersonality> = {
  master: {
    ...
    palette: { ink: "#071d67", primary: "#315fd7", secondary: "#592bd6", accent: "#12cdd4", canvas: "#f5f7ff", surface: "#ffffff" },
    shape: "institutional",
    density: "spacious",
    motion: "restrained",
  },
  ...
  coach: {
    ...
    palette: { ink: "#071d67", primary: "#6b2bd9", secondary: "#12cdd4", accent: "#58e4b8", canvas: "#f4fbff", surface: "#ffffff" },
    shape: "expressive",
    density: "balanced",
    motion: "responsive",
  },
  teach: {
    ...
    palette: { ink: "#071d67", primary: "#6b2bd9", secondary: "#315fd7", accent: "#12cdd4", canvas: "#f7f6ff", surface: "#ffffff" },
    shape: "professional",
    density: "balanced",
    motion: "purposeful",
  },
  admin: {
    ...
    palette: { ink: "#071d67", primary: "#173a9d", secondary: "#315fd7", accent: "#12cdd4", canvas: "#f4f7fc", surface: "#ffffff" },
    shape: "structured",
    density: "compact",
    motion: "precise",
  },
