...
export const CAPABILITY_REGISTRY: readonly CapabilityRegistryEntry[] = [
  ...
  {
    id: "coach.live_streaming",
    owner: "COACH",
    product: "COACH",
    planEntitlementSource: ["plus", "ultra", "business_contract", "explicit_entitlement"],
    entitlementCapability: "live_streaming",
    quota: { metric: "voice_minutes", amount: 120, period: "month", pooled: true },
    aiProvider: "gemini",
    speechProvider: "standard",
    fallbackPolicy: "none",
    authorizationRequirement: "Authenticated learner with Coach access and live-streaming entitlement; server-resolved organization contract or individual tier.",
    organizationScope: "both",
    description: "Real-time Coach live speaking session authorization.",
    enabled: true,
  },
  {
