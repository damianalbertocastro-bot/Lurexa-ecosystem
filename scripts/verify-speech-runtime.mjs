...
if (route.includes("resolveLearningCapability")) {
  fail("Learn audio route must delegate capability resolution to the server audio service instead of duplicating it.");
}
...
pass("audio capability resolution has a single server-owned path");
