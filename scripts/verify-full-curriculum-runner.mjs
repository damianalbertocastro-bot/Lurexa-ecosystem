...
// 1. Verify A1, A2, and B1 Curriculum Data Definitions
...
check(b1Server.includes("stage: \"CONTEXTUAL_INPUT\""), "B1 provides CONTEXTUAL_INPUT model listening stage");
check(b1Server.includes("stage: \"CREATE_APPLY\""), "B1 provides CREATE_APPLY production stage");
check(b1Server.includes("stage: \"QUIZ\""), "B1 provides formative QUIZ assessment stage");
